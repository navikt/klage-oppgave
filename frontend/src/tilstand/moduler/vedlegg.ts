// import { IFile } from "../../../node_modules/forhandsvisningsfil";
...
// mimetype, size, name burde komme fra IFile?
...
const ATTACHMENT_ERROR_MESSAGES = {
  ...
  VIRUS:
    "Vi mistenker at filen din inneholder et virus, den kan derfor ikke sendes med i din klage.",
